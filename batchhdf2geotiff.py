...
OUTPUT_DIR_RELATIVE= "geotiffs_201706_LZA"  #"LunarZenithAngle" 
PATTERN='GDNBO-SVDNB_npp_d201706*.*h5'
DATASET = 'LunarZenithAngle' #'Radiance' #'LunarZenithAngle' 
...
for HDF in swath_files:
    try:
        ...
        with h5py.File(HDF,'r') as h5_file:
            edr=h5_file['All_Data/VIIRS-DNB-GEO_All'][DATASET][...] #h5_file['All_Data/VIIRS-DNB-SDR_All'][DATASET][...]
            lon_data=h5_file['All_Data/VIIRS-DNB-GEO_All']['Longitude'][...]
            lat_data=h5_file['All_Data/VIIRS-DNB-GEO_All']['Latitude'][...]
